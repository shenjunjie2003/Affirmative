...
app.add_url_rule('/results/<procedure>', 'results', results, methods=['POST', 'GET'])
...
#app.add_url_rule('/results_surgical', 'results_surgical', results_surgical, methods=['POST', 'GET'])
